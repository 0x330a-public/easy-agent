export const abi = [
	...
	},
	{
		...
		inputs: [
			...
			{ indexed: false, internalType: 'address', name: 'newStorageRegistry', type: 'address' }
		],
	...
	},
	{
		inputs: [],
		name: 'idRegistry',
		outputs: [{ internalType: 'contract IIdRegistry', name: '', type: 'address' }],
		stateMutability: 'view',
		type: 'function'
	},
	{
	...
	{
		inputs: [{ internalType: 'uint256', name: 'extraStorage', type: 'uint256' }],
		name: 'price',
		outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
		stateMutability: 'view',
		type: 'function'
	...
	{
		inputs: [{ internalType: 'address', name: '_storageRegistry', type: 'address' }],
		name: 'setStorageRegistry',
		outputs: [],
		stateMutability: 'nonpayable',
		type: 'function'
	},
	{
		...
		outputs: [{ internalType: 'contract IStorageRegistry', name: '', type: 'address' }],
		stateMutability: 'view',
		type: 'function'
	},
	{
