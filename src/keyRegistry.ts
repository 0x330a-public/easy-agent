export const abi = [
	...
	{
		anonymous: false,
		inputs: [{ indexed: false, internalType: 'address', name: 'keyGateway', type: 'address' }],
		name: 'FreezeKeyGateway',
		type: 'event'
	},
	{
		anonymous: false,
		inputs: [{ indexed: true, internalType: 'uint256', name: 'migratedAt', type: 'uint256' }],
		name: 'Migrated',
		type: 'event'
	},
	{
	...
	},
	{
		...
		inputs: [
			...
			{ indexed: false, internalType: 'address', name: 'newKeyGateway', type: 'address' }
		],
		name: 'SetKeyGateway',
		type: 'event'
	},
	...
	},
	{
		...
		inputs: [
			...
			{ indexed: false, internalType: 'address', name: 'newMigrator', type: 'address' }
		],
		name: 'SetMigrator',
		type: 'event'
	},
	...
	{
		inputs: [{ internalType: 'uint256', name: '_maxKeysPerFid', type: 'uint256' }],
		name: 'setMaxKeysPerFid',
		outputs: [],
		stateMutability: 'nonpayable',
		type: 'function'
